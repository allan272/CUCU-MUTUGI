...
export default function DashboardMortalityPage() {
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-primary">Mortality Log</h1>
          <p className="text-gray-600">Monitor losses and identify problem areas in your flocks.</p>
        </div>
        ...
        <table className="min-w-full text-left text-sm text-gray-700">
          <thead>
            <tr className="border-b border-gray-200">
              {['Date', 'Flock', 'Lost', 'Cause'].map((heading) => (
          ...
          <tbody>
            {[
              ['2026-06-11', 'Kuroiler Flock', '5', 'Cold stress'],
              ['2026-06-09', 'Layers Flock', '2', 'Infection'],
              ['2026-06-06', 'Broiler Flock', '3', 'Weak chicks'],
            ].map((row) => (
